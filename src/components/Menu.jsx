              ...
              <ul
                ...
                className={`${
                  hoveredMenu === title
                    ...
                    : "invisible top-[100px]"
                } w-[220px] absolute -left-[230px] lg:left-0 flex-col bg-white shadow-md p-4 rounded-md gap-1 font-montserrat font-medium text-black my-transition text-right lg:text-left`}
              >
